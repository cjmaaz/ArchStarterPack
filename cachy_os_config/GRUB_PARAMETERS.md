...
**Alternatives:**
- `intel_pstate=passive` - Uses ACPI CPUFreq governors (older behavior)
- Omitting parameter - Kernel auto-detects best mode
...
**Trade-offs:**
- **Pro:** Lower system overhead, fewer interrupts
...
**Purpose:** Enables Intel GuC (Graphics Micro Controller) firmware loading  
...
**Trade-offs:**
- **Pro:** Better power efficiency, hardware-accelerated media
- **Con:** Requires GuC/HuC firmware, may cause issues on older kernels
